...
\begin{itemize}
	...
	\item Veza: 
	\begin{itemize}
		\item Uređaj inicijatora u glavnoj je ulozi (engl. \textit{master}) - komunicira s uređajem u podređenoj (engl. \textit{slave}) ulozi i definira vrijeme prijenosa
...
\begin{figure}[ht]
	\includegraphics[]{imgs/ble_connection_setup}
